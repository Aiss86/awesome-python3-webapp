...
async def authenticate(*, email, passwd):
    ...
    if user.passwd != sha1.hexdigest():
        ...
        logging.info('[authenticate] authenticate sucessfully!!!')
...
async def get_blog(id):
    ...
    if blog is None:
        blog.html_content = '<h1> No Blog(%s) </h1>' % id 
    else:
...
async def api_create_blog(request, *, name, summary, content):
    ...
    blog = Blog(user_id=request.__user__.id, user_name=request.__user__.image,
